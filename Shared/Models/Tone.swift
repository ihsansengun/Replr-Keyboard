...
struct Tone: Codable, Identifiable, Equatable {
    ...
    static let presets: [Tone] = [
        ...
        Tone(id: UUID(), name: "Dirty Talk",        instruction: "Suggestive and explicitly sensual. Take whatever they said and turn the heat up. Bold, specific, no euphemisms. Make the reply impossible to ignore.",                                                                                                                                                            isPreset: true),
    ]
}
